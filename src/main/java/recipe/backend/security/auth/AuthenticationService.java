package recipe.backend.security.auth;
...
import recipe.backend.security.config.JwtService;
import recipe.backend.security.token.Token;
import recipe.backend.security.token.TokenRepository;
import recipe.backend.security.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    savedUser.setUser(ua);
    ua.setUser(savedUser);

    allSaved.setUserAccount(ua);
    ua.setFolder(List.of(allSaved));
    ...
    return AuthenticationResponse.builder()
        ...
        .user(LabMapper.INSTANCE.getUserAuthDTO(savedUser.getUser()))
        .build();
  }
  ...
  public AuthenticationResponse authenticate(AuthenticationRequest request) {
    ...
    return AuthenticationResponse.builder()
        .accessToken(jwtToken)
        .refreshToken(refreshToken)
        .user(LabMapper.INSTANCE.getUserAuthDTO(user.getUser()))
        .build();
  }
